...
export function ModalFooter({ children, center }: { children: React.ReactNode, center?: boolean }) {
    return (
        <div className={`flex items-center ${center ? 'justify-center' : 'justify-end'} gap-3 mt-8 pt-6 border-t border-border/40`}>
            {children}
        </div>
    );
}
