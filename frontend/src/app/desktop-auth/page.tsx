                        ...
                        <div className="space-y-6">
                            ...
                            {user && (
                                <div className="bg-muted/40 border border-border/40 rounded-2xl p-4 flex items-center gap-3">
                                    <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-bold text-sm overflow-hidden">
                                        {(user as any).avatarUrl ? (
                                            <img src={(user as any).avatarUrl} alt={user.displayName || user.username} className="w-full h-full object-cover" />
                                        ) : (
