    ...
    const handleAutoDownload = async (id: string) => {
        try {
            const res = await axios.post(
                `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/links/${id}/verify`,
                {}
            );
            ...
            <div className="w-full max-w-md">
                ...
                <div className="flex flex-col items-center mb-10">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-extrabold text-2xl text-foreground tracking-tightest">Cloud Shakes</span>
                    </div>
                ...
                <div className="mt-12 flex flex-col items-center gap-6">
                    <div className="flex items-center gap-3 py-2 px-5 bg-muted/40 rounded-full border border-border/40">
                        ...
                        <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Transferencia Segura de Cloud Shakes</span>
                    </div>
